...
joblib.dump(lr,'models/logistic_v2.pkl')
...
plt.savefig("models/result/v2/logistic_v2.png")
plt.close()
...
plt.savefig("models/result/v2/random_forest_v2.png")
plt.close()
...
plt.savefig("models/result/v2/svm_v2.png")
plt.close()